...
public class SignUpByEmailResultStorageModel {
    private boolean isSignUpSuccessful;
    private String notification;

    public SignUpByEmailResultStorageModel() {
    }

    public SignUpByEmailResultStorageModel(boolean isSignUpSuccessful, String notification) {
    ...
    public boolean equals(Object o) {
        ...
        SignUpByEmailResultStorageModel that = (SignUpByEmailResultStorageModel) o;
