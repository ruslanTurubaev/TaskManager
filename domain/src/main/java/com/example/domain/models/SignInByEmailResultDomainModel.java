...
public class SignInByEmailResultDomainModel {
    private boolean isEmailVerified;
    private boolean isSignInSuccessful;
    private String notification;

    public SignInByEmailResultDomainModel(boolean isEmailVerified, boolean isSignInSuccessful, String notification) {
    ...
    public boolean equals(Object o) {
        ...
        SignInByEmailResultDomainModel that = (SignInByEmailResultDomainModel) o;
